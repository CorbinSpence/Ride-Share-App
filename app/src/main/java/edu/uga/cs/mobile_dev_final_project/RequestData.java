...
public class RequestData {
    ...
    public RequestData(String posterID, String posterName, String posterGender, String pickupAddress, String destinationAddress, String dateOfRide, int travelType) {
